...
/**
 * Class Login_Interstitial_Config_Driven
 */
class Login_Interstitial_Config_Driven extends Login_Interstitial_Base {

	/** @var array */
	private $config;

	/**
	 * Login_Interstitial_Config_Driven constructor.
	 *
	 * @param array $config
	 *
	 ...
	 * @inheritDoc
	 */
	public function render( Login_Interstitial_Session $session, array $args ) {
